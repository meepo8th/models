...
PATH_TO_FIND_IMAGES_DIR = 'D:/pic/person'
PATH_PROCESS_IMAGES_DIR = 'D:/pic/label'
...
def generateLabel(boxes, classes, scores, image_path, imageSize):
    ...
    for i, score in enumerate(scores):
        if (score > 0.7 and classes[i] in category_index and "person" == category_index[classes[i]]['name']):
