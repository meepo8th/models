...
flags = tf.app.flags
flags.DEFINE_string('data_dir', 'E:/picRecord/data/data', 'Root directory to raw PASCAL VOC dataset.')
...
flags.DEFINE_string('output_path', 'E:/picRecord/data/record/pascal_test.record', 'Path to output TFRecord')
